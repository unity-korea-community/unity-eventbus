...
namespace UNKO.EventBus
{
    ...
    /// </summary>
    public class GlobalEventBus : MonoBehaviour, IUnifiedEventBus
    {
        [SerializeField]
        private EventBusLogic _eventBusLogic = new EventBusLogic(Scope.Global);
        [SerializeField]
        private ResponseEventBusLogic _responseEventBusLogic = new ResponseEventBusLogic(Scope.Global);
